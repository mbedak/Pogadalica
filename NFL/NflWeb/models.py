...
class Utakmice(models.Model):
    ...
    gosti_spread = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, blank=True, null=True)
    domaci_spread = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, blank=True, null=True)
